...
$body = @{ principalId=$logicAppManagedId; resourceId=$graphSpId; appRoleId=$roleId } | ConvertTo-Json

az rest --method POST --uri "https://graph.microsoft.com/v1.0/servicePrincipals/$logicAppManagedId/appRoleAssignments" --headers "Content-Type=application/json" --body "$body"
